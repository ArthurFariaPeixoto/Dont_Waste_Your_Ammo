...
public class GreenSlime extends Entitie {
    ...
    public GreenSlime(int x, int y, int width, int height, BufferedImage sprite) {
        super(x, y, width, height, null);

        sprites = new BufferedImage[5];
        sprites[0] = Game.spritesheet.getSprite(128, 112, 16, 16);
        sprites[1] = Game.spritesheet.getSprite(144,112, 16, 16);
        sprites[2] = Game.spritesheet.getSprite(128, 128, 16, 16);
        sprites[3] = Game.spritesheet.getSprite(144,112, 16, 16);
        sprites[4] = Game.spritesheet.getSprite(144,128, 16, 16);
